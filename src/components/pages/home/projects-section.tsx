...
import { ease } from '@/components/layout/inner'
...
export function Card({ ...props }: CardProps) {
  ...
  return (
    <motion.div
      className='overflow-hidden shrink-0 h-[calc(100vh-160px)] aspect-[9/16] cursor-pointer card bg-black rounded-3xl mr-8'
