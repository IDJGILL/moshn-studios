...
const FormControl = forwardRef<React.ElementRef<'div'>, React.ComponentPropsWithoutRef<'div'>>((_, ref) => {
...
const ForwardProps = forwardRef<HTMLElement, ForwardPropsProps>(({ children, ...props }, ref) => {
